<?php
	$LANG = array (
		...
		// article - action
		"art-login-preform-action" => "log in",
		"art-insufficient-rights-to-set-as-processed" => "u heeft onvoldoende rechten voor deze handeling",
		"art-unsupported-status-change" => "statusverandering niet ondersteund",
		"art-no approves yet" => "nog geen goedkeuringen ontvangen",
		"art-please-add-a-comment" => "voeg een opmerking toe",
		"art-successfully-updated" => "succesvol bijgewerkt",
		"art-status-changed-in-between" => "de status is tussentijds aangepast",

		// article - status
		"art-status-draft" => "status: schets",
		"art-status-review" => "status: in review",
		"art-status-approved" => "status: goedgekeurd",
		"art-status-published" => "status: gepubliceerd",
		"art-status-retracted" => "status: teruggetrokken",

		// article - comment
		"art-blocking" => "blokkeer",
		"art-review-comments" => "review opmerkingen",
		"art-no-comments-yet" => "nog geen opmerkingen",
		"art-add-review-comment" => "voeg opmerking toe",
		...
		"art-method" => "methode",
		"art-sources" => "bronnen",
		"art-is-resolved" => "opgelost",
		"art-is-blocking" => "geblokkeerd",
		"art-set-as-resolved" => "zet op opgelost",
		"art-set-as-closed" => "zet op afgesloten",
